...
class ImageCreator():
    ...
    def __init__(self):
        ...
        self.hostname = ""
        self.np_arr = 0
        self.folder_name = '/media/arg_ws3/5E703E3A703E18EB/data/mm_unity/test/' #write your folder name betweer ' /'
        is_compressed = False
        #---bag part---
        #os.chdir("Downloads")
        for file in glob.glob("/media/arg_ws3/10D4C51CD4C504C6/bag/inside_0.bag"):
                ...
                for topic,msg,t in bag.read_messages():
                    ...
                    if topic == "/camera/color/image_rect_color":
                        ...
                        try:
                            ...
                            print(e)
                        if self.counter % 2 == 0:
                            image_name = "inside1_" + str(self.image_num) + ".jpg"
