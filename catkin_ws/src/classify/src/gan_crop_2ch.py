...
class SPARSE2DENSE():
	def __init__(self):
		...
		self.net.load_weights('/home/arg_ws3/gan_rv/catkin_ws/src/classify/src/barcode.pth')
		if torch.cuda.is_available():
			self.net = self.net.cuda()

		self.generator = GeneratorUNet(in_channels=3, out_channels=2)
		if self.cuda:
			self.generator = self.generator.cuda()
		self.generator.load_state_dict(torch.load('/media/arg_ws3/5E703E3A703E18EB/research/pix2pix_cropmask/saved_models/mm_barcode/generator_84.pth'))
