...
parser.add_argument('--dataset_name', type=str, default="rgb2mask", help='name of the dataset')
...
print(opt)
root = '/media/arg_ws3/5E703E3A703E18EB/research/pix2pix_person/'
...
dataloader = DataLoader(ImageDataset("/media/arg_ws3/5E703E3A703E18EB/data/person_seg/", transforms_A=transforms_B, transforms_B=transforms_B),
                        batch_size=opt.batch_size, shuffle=True, num_workers=opt.n_cpu)

val_dataloader = DataLoader(ImageDataset("/media/arg_ws3/5E703E3A703E18EB/data/person_seg/", transforms_A=transforms_B, transforms_B=transforms_B, mode='val'),
