...
parser.add_argument('--dataset_name', type=str, default="mm_barcode", help='name of the dataset')
...
dataloader = DataLoader(ImageDataset("/media/arg_ws3/5E703E3A703E18EB/data/mm_barcode/", transforms_A=transforms_B, transforms_B=transforms_B),
                        batch_size=opt.batch_size, shuffle=True, num_workers=opt.n_cpu)

val_dataloader = DataLoader(ImageDataset("/media/arg_ws3/5E703E3A703E18EB/data/mm_barcode/", transforms_A=transforms_B, transforms_B=transforms_B, mode='test'),
